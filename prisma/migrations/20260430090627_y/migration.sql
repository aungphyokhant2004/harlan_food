/*
  ...
  - You are about to alter the column `paymentScreenshot` on the `Reservation` table. The data in that column could be lost. The data in that column will be cast from `String` to `Binary`.
...
CREATE TABLE "new_Reservation" (
    ...
    "understoodLeadTime" BOOLEAN NOT NULL DEFAULT true,
