/*
  ...
  - You are about to drop the `MenuType` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the column `menuTypeId` on the `MenuCategory` table. All the data in the column will be lost.
  - You are about to drop the column `menuTypeId` on the `MenuItem` table. All the data in the column will be lost.
